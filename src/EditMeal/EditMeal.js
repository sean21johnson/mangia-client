			...
			<div className="EditMeal">
				<form className="EditMeal_form" onSubmit={this.handleEditSubmit}>
					...
					<div className="edit_image_section">
						...
						<input
							className="edit_image_class"
							type="text"
							name="edit_meal_image"
							id="edit_meal_image"
					...
					<div className="edit_category_section">
						...
						<select
							className="edit_category_class"
							name="edit_meal_category"
							required
						>
					...
					<div className="edit_description_section">
						...
						<textarea
							className="edit_description_class"
							type="text"
							name="edit_meal_description"
							id="edit_meal_description"
