...
class NavMeal extends Component {
	...
	handleSearchChoice = (e) => {
		if (e.key === "Enter") this.context.searchFilter(e.target.value);
	};
		...
		return (
			<div className="NavMeal">
				<input
					...
					onKeyUp={this.handleSearchChoice}
					placeholder="Search for Meal"
				/>
				<Link to="/add-meal" className="Create_Meal">
					Add Meal
				</Link>
				<select
					onChange={this.handleCategoryChoice}
					value={this.context.dropdownText}
